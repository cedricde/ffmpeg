 ...
 * Copyright (C) 2022-2024 Cedric Delmas
 *
...
const FFInputFormat ff_nvfbc_demuxer = {
    .p.name         = "nvfbc",
    .p.long_name    = NULL_IF_CONFIG_SMALL("X11 screen capture, using NvFBC"),
    .p.flags        = AVFMT_NOFILE,
    .p.priv_class   = &nvfbc_class,
